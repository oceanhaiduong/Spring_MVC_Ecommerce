...
<div class="container-fluid">
	...
	<div class="row align-items-center py-3 px-xl-5">
		...
		<div class="col-lg-3 col-6 text-right">
			<a href="" class="btn border"> <i class="fas fa-shopping-cart"></i>
					...
					<c:choose>
						<c:when test="${Categories != null}">
							<c:forEach var="category" items="${Categories}">
								<a href="" class="nav-item nav-link">${category.name_type}</a>
				...
				<div class="collapse navbar-collapse justify-content-between"
					...
					<div class="navbar-nav mr-auto py-0">
						<a href="index.html" class="nav-item nav-link active">Trang
							chủ</a> <a href="shop.html" class="nav-item nav-link">Cửa hàng</a>
						<div class="nav-item dropdown">
