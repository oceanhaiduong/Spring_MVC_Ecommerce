							...
							<div class="row align-items-center">
								<div class="col-xl-8 col-xxl-12">
									<div
										...
										<p class="text-gray-700 mb-0">Browse our fully designed UI
											toolkit! Browse our prebuilt app pages, components, and
											utilites, and be sure to look at our full documentation!</p>
									</div>
								</div>
								<div class="col-xl-4 col-xxl-12 text-center">
									<img class="img-fluid"
										src="{{ asset('css/admin/img/illustrations/at-work.svg') }}"
						...
						<div class="card-body">
							<div class="timeline timeline-xs">
								...
								<div class="timeline-item">
									...
									<div class="timeline-item-content">
										Your <a class="fw-bold text-dark" href="#!">weekly report</a>
